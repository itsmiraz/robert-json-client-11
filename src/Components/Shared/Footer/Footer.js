                ...
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full  bg-violet-400">
                            <img className='rounded-full' src="https://cdn.vectorstock.com/i/preview-1x/54/66/best-initial-letter-r-logo-design-graphic-download-vector-35165466.jpg" alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold">Robert Json</span>
                    </a>
                </div>
